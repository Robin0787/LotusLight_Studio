                        ...
                        <article className='md:w-1/2 space-y-4'>
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div className='space-y-1 w-1/2'>
                                    ...
                                    <input type="text"
                                        className='p-2 text-sm focus:px-3  bg-white focus:outline-0 border w-full focus:ring-1 ring-blue-200 rounded-md duration-300 placeholder:text-xs placeholder:tracking-[2px] placeholder:font-thin' placeholder='Address' />
                                </div>
                            </div>
